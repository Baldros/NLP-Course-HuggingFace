...
Segundo o apresentado, em geral, modelos pré-treinando tem um desempenho melhor do que modelos treinandos do zero. Isso ocorre porque os modelos pré-treinados normalmente são treinados em grandes quantidades de dados, mas fornecem um modelo com uma compreensão estatística da linguagem usada durante o pré-treinamento.
