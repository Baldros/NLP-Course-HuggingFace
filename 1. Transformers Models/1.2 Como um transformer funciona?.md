...
Como o modelo pré-treinado já foi treinado em muitos dados, a afinação requer muito menos dados para obter resultados decentes.

Por causa disso, a quantidade de tempo e recursos necessários para obter bons resultados é muito menor.
...
Esse processo também alcançará resultados melhores do que treinar do zero (a menos que você tenha muitos dados), razão pela qual você sempre deve tentar aproveitar um modelo pré-treinado - um o mais próximo possível da tarefa que você tem em mãos - e realizar a afinação.
...
do modelo são carregados para outras aplicações que se queiram fazer com aquele respectivo modelo.
